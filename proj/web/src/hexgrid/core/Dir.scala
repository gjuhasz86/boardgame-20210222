...
object Dirs {
  case object UR extends Dir(0, 0.5, -0.5, -1, 1)
  case object RR extends Dir(1, 1.0, 0.0, 0, 1)
  case object DR extends Dir(2, 0.5, 0.5, 1, 0)
  case object DL extends Dir(3, -0.5, 0.5, 1, -1)
  case object LL extends Dir(4, -1.0, 0.0, 0, -1)
  case object UL extends Dir(5, -0.5, -0.5, -1, 0)
